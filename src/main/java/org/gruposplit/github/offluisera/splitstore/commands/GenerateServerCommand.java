...
/**
 * ============================================
 * COMANDO: /splitstore genserver <nome>
 * ============================================
 * Gera um Server ID único para conectar ao painel web
 */
public class GenerateServerCommand implements CommandExecutor {

    private final SplitStore plugin;

    public GenerateServerCommand(SplitStore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage(ChatColor.RED + "✗ Uso correto: /splitstore genserver <nome>");
     ...
     * ============================================
     */
    private void handleGenServer(CommandSender sender, String[] args) {
